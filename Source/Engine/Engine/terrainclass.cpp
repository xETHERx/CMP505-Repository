...
void TerrainClass::MidPoint(int xmin, int xmax, int zmin, int zmax)
{
	...
	{
		MidPoint(xmin, (xmin + xmax) / 2, zmin, (zmin + zmax) / 2);
		MidPoint(xmin, (xmin + xmax) / 2, (zmin + zmax) / 2, zmax);
		MidPoint((xmin + xmax) / 2, xmax, zmin, (zmin + zmax) / 2);
		MidPoint((xmin + xmax) / 2, xmax, (zmin + zmax) / 2, zmax);
	}
	return;
}
